...
const s = {
  ...
  fieldTextarea: { width:'100%', padding:'9px 10px', background:'#1e1e1e', border:'1px solid #2a2a2a', borderRadius:8, color:'#fff', fontSize:13, resize:'vertical', fontFamily:'inherit' },
  chordBox: { width:'100%', padding:'10px 12px', background:'#111', border:'1px solid #2a2a2a', borderRadius:8, color:'#60a5fa', fontSize:14, fontFamily:'monospace', resize:'vertical', minHeight:70 },
